...
class SliderParameter(bench.Panel):
    def __init__(self, name, min_val, max_val, valstep=None):
        super().__init__()

        self.min_val = min_val
        self.max_val = max_val
        self.val_step = valstep
    ...
    def place_on(self, figure):
        ...
        self.slider = Slider(ax, self.parameter.name, self.min_val, self.max_val, valstep=self.val_step,
